...
declare -A secondary_urls=(
  ...
  ["nlohmann"]="http://raw.githubusercontent.com/nlohmann/json/4f8fba14066156b73f1189a2b8bd568bde5284c5/single_include/nlohmann/json.hpp"
  ["neo4j"]="http://s3-eu-west-1.amazonaws.com/deps.memgraph.io/neo4j-community-3.2.3-unix.tar.gz"
...
# cppitertools v2.0 2019-12-23 hjm
